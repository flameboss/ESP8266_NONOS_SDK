...
ifeq ($(app), 0)
	@python3 ../tools/gen_appbin.py $< 0 $(mode) $(freqdiv) $(size_map) $(app)
    ...
    ifneq ($(boot), new)
		@python3 ../tools/gen_appbin.py $< 1 $(mode) $(freqdiv) $(size_map) $(app)
		@echo "Support boot_v1.1 and +"
    else
		@python3 ../tools/gen_appbin.py $< 2 $(mode) $(freqdiv) $(size_map) $(app)
